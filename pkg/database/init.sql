...
-- 插入支持的链数据（包含主网和测试网）
INSERT INTO support_chains (chain_name, display_name, chain_id, native_token, is_testnet, is_active, logo_url, alchemy_rpc_template, infura_rpc_template, custom_rpc_url, rpc_enabled) VALUES
-- 主网
