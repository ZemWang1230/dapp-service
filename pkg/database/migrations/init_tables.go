...
func (h *MigrationHandler) createInitialTables(ctx context.Context) error {
	...
	if !h.db.Migrator().HasTable("error_logs") {
		...
		if err := h.db.WithContext(ctx).Exec(createErrorLogsTable).Error; err != nil {
	...
	mainnets := []map[string]interface{}{
		{
			...
			"is_testnet":               false,
			"is_active":                true,
			"official_rpc_urls":        `["https://eth.llamarpc.com","https://rpc.mevblocker.io","https://eth.merkle.io"]`,
		...
		},
		{
			...
			"chain_id":                 56,
			"native_currency_name":     "BNB Chain Native Token",
			"native_currency_symbol":   "BNB",
			"native_currency_decimals": 18,
			"logo_url":                 "https://raw.githubusercontent.com/timelock-labs/assets/main/chains/bsc-mainnet.png",
			"is_testnet":               false,
			"is_active":                true,
			"official_rpc_urls":        `["https://binance.llamarpc.com","https://bsc.drpc.org","https://api.zan.top/bsc-mainnet"]`,
		...
		},
		{
			...
			"is_testnet":               false,
			"is_active":                true,
			"official_rpc_urls":        `["https://arb1.arbitrum.io/rpc","https://arbitrum.drpc.org","https://api.zan.top/arb-one"]`,
		...
		},
		{
			...
			"is_testnet":               false,
			"is_active":                true,
			"official_rpc_urls":        `["https://mainnet.optimism.io","https://optimism.drpc.org","https://0xrpc.io/op"]`,
		...
		},
		{
			...
			"is_testnet":               false,
			"is_active":                true,
			"official_rpc_urls":        `["https://mainnet.base.org","https://base.llamarpc.com","https://base.drpc.org"]`,
		...
		},
		{
			...
			"display_name":             "Linea",
			"chain_id":                 59144,
			"native_currency_name":     "Linea Ether",
			"native_currency_symbol":   "ETH",
			"native_currency_decimals": 18,
			"logo_url":                 "https://raw.githubusercontent.com/timelock-labs/assets/main/chains/linea-mainnet.png",
			"is_testnet":               false,
			"is_active":                true,
			"official_rpc_urls":        `["https://rpc.linea.build", "https://linea.drpc.org","https://rpc.poolz.finance/linea"]`,
		...
		},
		{
			...
			"is_testnet":               false,
			"is_active":                true,
			"official_rpc_urls":        `["https://rpc.scroll.io","https://scroll.drpc.org"]`,
		...
		},
		{
			...
			"chain_id":                 196,
			"native_currency_name":     "X Layer Global Utility Token",
			"native_currency_symbol":   "OKB",
			"native_currency_decimals": 18,
			"logo_url":                 "https://raw.githubusercontent.com/timelock-labs/assets/main/chains/xlayer-mainnet.png",
			"is_testnet":               false,
			"is_active":                true,
			"official_rpc_urls":        `["https://rpc.xlayer.tech","https://xlayerrpc.okx.com","https://rpc.ankr.com/xlayer","https://xlayer.drpc.org"]`,
		...
		},
		{
			...
			"is_testnet":               false,
			"is_active":                true,
			"official_rpc_urls":        `["https://rpc.ankr.com/bitlayer","https://rpc.bitlayer-rpc.com","https://rpc.bitlayer.org"]`,
		...
		},
		{
			...
			"display_name":             "Core",
			"chain_id":                 1116,
			"native_currency_name":     "Core Blockchain Native Token",
			"native_currency_symbol":   "CORE",
			"native_currency_decimals": 18,
			"logo_url":                 "https://raw.githubusercontent.com/timelock-labs/assets/main/chains/core-mainnet.png",
			"is_testnet":               false,
			"is_active":                true,
			"official_rpc_urls":        `["https://rpc.ankr.com/core","https://rpc.coredao.org","https://core.drpc.org","https://api.zan.top/core-mainnet"]`,
		...
		},
		{
			...
			"is_testnet":               false,
			"is_active":                true,
			"official_rpc_urls":        `["https://rpc.ankr.com/goat_mainnet", "https://rpc.goat.network","https://goat-mainnet-alpha.drpc.org"]`,
		...
		},
		{
			...
			"is_testnet":               false,
			"is_active":                true,
			"official_rpc_urls":        `["https://rpc.ankr.com/b2","https://rpc.bsquared.network","https://mainnet.b2-rpc.com","https://b2-mainnet.alt.technology"]`,
		...
		},
		{
			...
			"is_testnet":               false,
			"is_active":                true,
			"official_rpc_urls":        `["https://rpc.zklink.io","https://rpc.zklink.network"]`,
		...
		},
		{
			...
			"is_testnet":               false,
			"is_active":                true,
			"official_rpc_urls":        `["https://rpc.merlinchain.io", "https://merlin.drpc.org","https://merlin.blockpi.network/v1/rpc/public"]`,
		...
		// },
		{
			...
			"chain_id":                 177,
			"native_currency_name":     "HashKey EcoPoints",
	...
	testnets := []map[string]interface{}{
		{
			...
			"is_testnet":               true,
			"is_active":                true,
			"official_rpc_urls":        `["https://rpc.sepolia.ethpandaops.io","https://0xrpc.io/sep","https://api.zan.top/eth-sepolia"]`,
		...
		},
		{
			...
			"is_testnet":               true,
			"is_active":                true,
			"official_rpc_urls":        `["https://api.zan.top/bsc-testnet","https://bsc-testnet.drpc.org","https://bsc-testnet.bnbchain.org"]`,
